...
let btnTodo = document.getElementById('btn');
let errorMessage = document.getElementById('error');
let todoBox = document.getElementById('display-box');
...
const fetchTodos = () => {
    ...
    const todos = todo_db.sort((a, b) => a.created_at < b.created_at ? 1 : a.created_at > b.created_at ? -1 : 0
      ...
      <div class="flex w-[12%] justify-between hidden group-hover:flex">
        <svg xmlns="http://www.w3.org/2000/svg" color="blue" onclick="handleEditMode('${id}')" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
