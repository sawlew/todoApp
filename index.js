...
const fetchTodos = () => {
    ...
    if(noTodo){
      todoBox.innerHTML = `<p class="text-center pt-5 text-blue-300">Your todos will appear here</p>`;
      return;
    }
    ...
    const todos = todo_db.sort((a, b) => a.created_at < b.created_at ? 1 : a.created_at > b.created_at ? -1 : 0
        ...
        return `
        <div class="group flex justify-between p-3 mb-5 rounded bg-blue-100 hover:bg-blue-200">
      <p class="overflow-ellipsis overflow-hidden">${todo.title}</p>
      <div class="flex w-[12%] justify-between hidden group-hover:flex cursor-pointer">
